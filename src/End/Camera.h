...
protected:
	...
	double m_autoMoveDely;
	double m_autoMoveCount;
...
public:
	...
	// 自动回到车体运行前方
	void MoveToFront(DirectX::XMFLOAT3 targetFront, DirectX::XMFLOAT3 targetUp, float dt);
...
public:
	...
	DirectX::XMVECTOR GetTargetPositionXM() const;
	// 获取与物体的距离
	...
	void UpdateViewMatrix() override;
	// 自动回到车体行进前方
	void MoveToFront(DirectX::XMFLOAT3 targetFront, float dt);
	// 
	void Adjust(Land& land);
